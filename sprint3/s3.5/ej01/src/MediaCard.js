        ...
        <div className="App2">
          <header className="App-header">
            ...
            <div className="Div_text">
              <h4 className="MyName"> Aylén Ortiz</h4>
          ...
          <p className="App-intro">
            ...
            sequi explicabo impedit ratione tempora atque. Quae quo ratione cumque
            perspiciatis quos temporibus, sunt rerum, itaque quam, explicabo
            corrupti assumenda...
          </p>
